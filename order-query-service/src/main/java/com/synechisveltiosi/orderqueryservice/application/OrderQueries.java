...
public class OrderQueries {
    private final JdbcTemplate jdbc; private final ProjectionCodec codec;
    public OrderQueries(JdbcTemplate jdbc, ProjectionCodec codec) { this.jdbc = jdbc; this.codec = codec; }
    ...
    public Page list(UUID customer, boolean admin, String status, int page, int size) {
        ...
        var args = new ArrayList<Object>(Arrays.asList(generation, admin, customer)); if (status != null) args.add(status);
