...
public class CompensationListener {
    ...
    private final CompensationTransactions compensation;

    public CompensationListener(JsonMapper json, CompensationTransactions compensation) {
        this.json = json;
    ...
    public void receive(ConsumerRecord<String, String> record) {
        ...
        if (!event.aggregateId().toString().equals(record.key()))
            throw new IllegalArgumentException("Wrong compensation key");
