...
public class OrderEventListener {
    ...
    public OrderEventListener(JsonMapper json, InventoryService inventory) { this.json = json; this.inventory = inventory; }
    ...
    public void receive(ConsumerRecord<String, String> record) {
        ...
        if (!event.payload().orderId().toString().equals(record.key())) throw new IllegalArgumentException("Order event key mismatch");
