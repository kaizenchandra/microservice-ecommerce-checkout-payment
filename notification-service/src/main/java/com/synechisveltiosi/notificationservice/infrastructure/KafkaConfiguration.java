...
public class KafkaConfiguration {
    static final String DLT_SUFFIX = ".notification-service.DLT";
    ...
    @Bean
    DefaultErrorHandler notificationErrorHandler(KafkaTemplate<String, String> kafka, MeterRegistry metrics) {
