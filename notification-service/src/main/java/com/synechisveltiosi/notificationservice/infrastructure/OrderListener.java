...
public class OrderListener {
    private final JsonMapper json; private final NotificationTransactions notifications;
    public OrderListener(JsonMapper json, NotificationTransactions notifications) { this.json = json; this.notifications = notifications; }
    ...
    public void receive(ConsumerRecord<String, String> record) {
        ...
        if (!event.aggregateId().toString().equals(record.key())) throw new IllegalArgumentException("Wrong notification key");
