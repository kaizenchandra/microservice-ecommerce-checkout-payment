...
public final class PaymentEvents {
    ...
    public record InventoryReserved(UUID orderId, UUID customerId, List<Line> items,
        ...
        public InventoryReserved {
            ...
            if (paymentToken == null || !Set.of("tok_success", "tok_declined", "tok_timeout", "tok_error").contains(paymentToken)) throw new IllegalArgumentException("Invalid demo token");
