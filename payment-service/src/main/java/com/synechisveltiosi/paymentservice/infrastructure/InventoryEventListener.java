...
public class InventoryEventListener {
    ...
    public InventoryEventListener(JsonMapper json, PaymentTransactions payments) { this.json = json; this.payments = payments; }
    ...
    public void receive(ConsumerRecord<String, String> record) {
        ...
        if (!event.payload().orderId().toString().equals(record.key())) throw new IllegalArgumentException("Inventory event key mismatch");
