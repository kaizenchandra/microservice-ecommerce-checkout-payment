...
* [Spring Cloud compatibility matrix](https://spring.io/projects/spring-cloud/) pairs 2025.1.x with Boot 4.0.x and lists
  2025.1.2.
* [Resilience4j 2.4.0 release](https://github.com/resilience4j/resilience4j/releases/tag/v2.4.0) adds Boot 4 / Cloud 5
  support.
* [Boot 4 migration guide](https://github.com/spring-projects/spring-boot/wiki/Spring-Boot-4.0-Migration-Guide)
  documents modular Kafka starters and migration considerations.
